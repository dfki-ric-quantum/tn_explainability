...
from tn.tune.simple import get_objective

FLAGS = flags.FLAGS
flags.DEFINE_enum("estimator", None, ["svm", "if"], short_name="e", help="Estimator to tune")
flags.DEFINE_enum(
    "dataset",
    None,
...
def main(_) -> None:
    ...
    study_name = f"{FLAGS.estimator}-{FLAGS.dataset}-{time}"
    ...
    objective = get_objective(
        FLAGS.estimator, FLAGS.dataset, seed, N_SPLITS, n_jobs=N_JOBS
    )
